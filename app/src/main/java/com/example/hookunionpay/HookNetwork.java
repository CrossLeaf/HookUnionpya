...
public class HookNetwork implements IXposedHookLoadPackage {
    private String TARGET_APP = "com.unionpay";
    ...
    private String TAG = "HookNetwork";

    @Override
    public void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
        Log.i(TAG, "handleLoadPackage: http hook start.");
...
// TODO Auto-generated catch block
    ...
    public void hookOncreate(LoadPackageParam lpparam) {
        ...
        if (appClassName == null) {
            Log.i(TAG, "hookOncreate: appClassName = null");
            ...
            Log.i(TAG, "hookOncreate: " + appClassName);
